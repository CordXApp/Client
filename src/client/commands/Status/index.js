...
module.exports = {
  ...
  run: async (client) => {
    ...
    switch (method) {
      case "prod_site":
        const prodCheck = new UptimeClient("https://cordx.lol", {
          timeout: 5000,
        });
        ...
        await client.interaction.reply({
          embeds: [
            new client.Gateway.EmbedBuilder()
              ...
              .setDescription(
                "Please wait while i attempt to ping the website and check its response time, this may take a few seconds....",
              )
              .setTimestamp()
              .setFooter({
                text: client.footer,
                ...
                .addFields(
                  {
                    name: "Status",
                    value: `${
                      prodCheck.available ? "🟢 ONLINE" : "🔴 OFFLINE"
                    }`,
                    inline: false,
                  },
                  {
                  ...
                  },
                  {
                    name: "Round Trip",
                    value: `${
                      prodCheck.ping ? prodCheck.ping + "ms" : 0 + "ms"
                    }`,
                    inline: false,
                  },
                )
      ...
      case "beta_site":
        const betaCheck = new UptimeClient("https://beta.cordx.lol", {
          timeout: 5000,
        });
                ...
                .addFields(
                  {
                    name: "Status",
                    value: `${
                      betaCheck.available ? "🟢 ONLINE" : "🔴 OFFLINE"
                    }`,
                    inline: false,
                  },
                  {
                  ...
                  },
                  {
                    name: "Round Trip",
                    value: `${
                      betaCheck.ping ? betaCheck.ping + "ms" : 0 + "ms"
                    }`,
                    inline: false,
                  },
                )
