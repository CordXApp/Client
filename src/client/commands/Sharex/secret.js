            ...
            .send({
              embeds: [
                new client.Gateway.EmbedBuilder()
                  ...
                  .setThumbnail(client.logo)
                  .setDescription(
                    "Here is your upload/sharex secret. It goes into your sharex config which can be downloaded from our website!",
                  )
                  .addFields({
                    name: "Secret",
                    value: `${row[0].secret}`,
              ...
              return client.interaction.reply({
                embeds: [
                  new client.Gateway.EmbedBuilder()
                    ...
                    .setThumbnail(client.logo)
                    .setDescription(
                      "Failed to send your secret via DMs. Please make sure you are allowing DMs from guild members or use the ephemeral method which will send it via a private message!",
                    )
                    .setTimestamp()
                    .setFooter({
                      text: client.footer,
