              ...
              return client.interaction.reply({
                embeds: [
                  new client.Gateway.EmbedBuilder()
                    ...
                    .setThumbnail(client.logo)
                    .setDescription(
                      "Failed to send your cookie via DMs. Please make sure you are allowing DMs from guild members or use the ephemeral method which will send it via a private message!",
                    )
                    .setTimestamp()
                    .setFooter({
                      text: client.footer,
