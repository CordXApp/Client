        ...
        switch(method) {
                ...
                .then(user => {
                    ...
                    return client.interaction.reply({
                        ...
                        embeds: [
                            ...
                            .setDescription('Here is your cookie, right now it serves no purpose other then helping to identify you. Please make sure you do not share it')
                            .addFields({
                                name: 'Your Cookie',
                                value: `${user.cookie}`,
                                inline: false
            ...
            case "direct_message":
                    ...
                    .then(() => {
                        ...
                        return client.interaction.reply({
                            embeds: [
                                ...
                                .setColor(client.colors.base)
                                .setThumbnail(client.logo)
                                .setDescription('I have sent your cookie to you, please check your DM\'s')
                                .setTimestamp()
                                .setFooter({
                                    text: client.footer,
                                    iconURL: client.logo
                ...
                .catch(async (e) => {
                    ...
                    await client.logger(`${e.stack}`, { header: 'COOKIE_FETCH', type: 'error' })
