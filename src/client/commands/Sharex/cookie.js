            ...
            return client.interaction.reply({
              ...
              embeds: [
                new client.Gateway.EmbedBuilder()
                  ...
                  .setDescription(
                    "Here is your cookie, right now it serves no purpose other then helping to identify you. Please make sure you do not share it",
                  )
                  .addFields({
                    name: "Your Cookie",
                    value: `${user.cookie}`,
                ...
                return client.interaction.reply({
                  embeds: [
                    new client.Gateway.EmbedBuilder()
                      ...
                      .setThumbnail(client.logo)
                      .setDescription(
                        "I have sent your cookie to you, please check your DM's",
                      )
                      .setTimestamp()
                      .setFooter({
                        text: client.footer,
