...
module.exports = {
    ...
    run: async(client) => {
        ...
        if (cmd && !client.slash.get(cmd)) return client.interaction.reply({ embeds: [
            new client.Gateway.EmbedBuilder()
            .setTitle('ERROR: Invalid Command')
            .setColor(client.color)
            .setThumbnail(client.logo)
            .setDescription('Hold up chief, the command you are looking for does not exist')
            .setTimestamp()
            .setFooter({
                text: client.footer,
                iconURL: client.logo
            ...
            return client.interaction.reply({ embeds: [
                ...
                .addFields(
                    ...
                    },
                    {
                        ...
                        value: `${!cmdFetch.userPerms.includes('') ? cmdFetch.userPerms : 'No special permissions required'}`,
                        inline: false
                    },
                    {
                        name: 'User Permissions',
                        value: `${!cmdFetch.basePerms.includes('') ? cmdFetch.basePerms : 'No user permissions required'}`,
                        inline: false
                    }
                )
                .setTimestamp()
