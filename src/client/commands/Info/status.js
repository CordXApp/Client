module.exports = {
    ...
    run: async (client) => {
        ...
        .then(sys => {
            ...
            else if (sys.page.status === 'HASISSUES') status = 'EXPERIENCING DEGRADED PERFORMANCE'
            else if (sys.page.status === 'UNDERMAINTENANCE') status = 'UNDER ACTIVE MAINTENANCE'
            ...
            return client.interaction.reply({
                embeds: [
                    ...
                    .setDescription(`All systems are: [${status}](https://beta.cordx.lol/status)`)
                    .setTimestamp()
                    .setFooter({
                        text: client.footer,
                        iconURL: client.logo
