      ...
      return client.interaction.reply({
        embeds: [
          new client.Gateway.EmbedBuilder()
            ...
            .setDescription(
              "Here is the current, newest and stable versions of our system(s)",
            )
            .addFields(
              {
                name: "Current",
      ...
      return client.interaction.reply({
        ...
        embeds: [
          new client.Gateway.EmbedBuilder()
            ...
            .setThumbnail(client.logo)
            .setDescription(
              "Whoops, something went wrong here, this could be caused by either our client module or our api itself!",
            )
            .addFields(
              {
                name: "Error",
